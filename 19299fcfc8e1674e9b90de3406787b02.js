    ...
    "/node_modules/jshint/src/lex.js": [function (_dereq_, module, exports) {
      ...
      Lexer.prototype = {
        ...
        scanNumericLiteral: function scanNumericLiteral() {
          ...
          if (_char2 !== "." && !isDecimalDigit(_char2)) {
            return null;
          }
          ...
          if (_char2 !== ".") {
            ...
            index += 1;
            _char2 = this.peek(index);

            if (value === "0") {
              if (_char2 === "x" || _char2 === "X") {
              ...
              if (!isOctalDigit(_char2) && isDecimalDigit(_char2)) {
                index += 1;
                value += _char2;
              }
            }
            ...
            while (index < length) {
              ...
              if (isLegacy && isDecimalDigit(_char2)) {
                bad = true;
              } else if (!isAllowedDigit(_char2)) {
                break;
              }
        ...
        scanEscapeSequence: function scanEscapeSequence(checks) {
          ...
          switch (_char3) {
            ...
            case "u":
              ...
              _char3 = String.fromCharCode(code);
              jump = 5;
              break;
        ...
        nextLine: function nextLine() {
          ...
          _char6 = this.scanNonBreakingSpaces();
